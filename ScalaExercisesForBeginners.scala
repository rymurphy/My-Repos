...
/**
 Solutions author: Ryan Murphy
 Problems author: Tony Morris
 Description: This is my attempt at solving Tony Morris' Scala exercises for beginners.
 URL: http://blog.tmorris.net/posts/scala-exercises-for-beginners/index.html
*/
...
object Exercises {
  ...
  def length[A](x: List[A]): Int ={
    x match{
      case Nil => 0
      case y :: lyst => succ(0) + length(lyst)
    }
  }
